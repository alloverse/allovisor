...
function NetworkScene:_init(displayName, url, avatarName)
  ...
  for _, avatarName in ipairs(lovr.filesystem.getDirectoryItems(avatarsRoot)) do
    for _, partName in ipairs({"head", "left-hand", "right-hand", "torso"}) do
      assets[avatarName.."/"..partName] = Asset.File(lovr.filesystem.getRealDirectory(avatarsRoot).."/"..avatarsRoot.."/"..avatarName.."/"..partName..".glb", true)
    end
  end
    ...
    children = {
      {
        geometry = {
          type = "asset",
          name = assets[avatarName.."/left-hand"]:id()
        },
        intent = {
      ...
      },
      {
        geometry = {
          type = "asset",
          name = assets[avatarName.."/right-hand"]:id()
        },
        intent = {
      ...
      },
      {
        geometry = {
          type = "asset",
          name = assets[avatarName.."/head"]:id()
        },
        material= {
          shader_name= "pbr"
        },
      ...
      },
      {
        geometry = {
          type = "asset",
          name = assets[avatarName.."/torso"]:id()
        },
        material= {
          shader_name= "pbr"
        },
